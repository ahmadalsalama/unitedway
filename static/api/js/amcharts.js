        ...
        parseDatesDraw: function() {
            ...
            if (0 < this.gridCountR)
                for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                    ...
                    m = l = p;
                    if (!isNaN(u))
                        for (h = 1; h < v; h += u) this.gridAlpha = this.minorGridAlpha, f = p + A * h, f = d.resetDateToMin(new Date(f), x, u, r).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0, void 0, void 0, void 0, void 0, void 0, !0), this.pushAxisItem(f);
                    this.gridAlpha = w
                }
        },
        ...
        draw: function() {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0;
                ...
                if ("date" == c) this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime = this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw();
                    ...
                    for (r >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), g = f; g < r; g += p)
                        if (c = u * g + this.minCalc, h && this.max - this.min > 10 * this.min && (c -= this.min), c = d.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c)
                            if (isNaN(w) || Number(d.toFixed(c, w)) == c) {
                                ...
                                A = new this.axisItemRenderer(this, f, A, void 0, K, void 0, void 0, this.boldLabels);
                                this.pushAxisItem(A);
    ...
    d.RecItem = d.Class({
        construct: function(a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            if ("H" == Ra) {
                ...
                z += t / 2;
                "right" == ca ? (E += qa + sa + ba, z += ka, P ? (f || (z -= t / 2 + 3), E = E - (B + 4) - oa) : (E += B + 4 + v, z -= 2, E += oa)) : P ? (E += B + 4 - ba, f || (z -= t / 2 + 3), g && (E += qa, z += ka), E += oa) : (E += -B - v - 4 - 2 - ba, z -= 2, E -= oa);
            ...
            Z && (Z.attr({
                "text-anchor": ga
            }), Z.translate(E, z, NaN, !0), 0 !== n && Z.rotate(-n, a.chart.backgroundColor), a.allLabels.push(Z), this.label = Z, d.setCN(p, Z, a.bcn + "label"), d.setCN(p, Z, q, !0), g && d.setCN(p, Z, "guide"));
    ...
    d.AmGraph = d.Class({
        ...
        createRadarGraph: function() {
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(q)) this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []);
                    ...
                    c.push(r);
                    if (!isNaN(p)) {
                        var u = this.y - (this.valueAxis.getCoordinate(p, this.noRounding) - this.height),
        ...
        createSerialGraph: function() {
            ...
            for (L = X; L <= fa; L++) {
                ...
                if (Ca) {
                    ...
                    switch (g) {
                        case "line":
                            if (isNaN(Y)) w || (this.drawLineGraph(A, v, T, U), A = [], v = [], T = [], U = []);
                            else {
                                ...
                                if (Ya || void 0 != z.lineColor || void 0 != z.fillColors || !isNaN(z.dashLength)) this.drawLineGraph(A, v, T, U), A = [H], v = [F], T = [], U = [], !La || isNaN(N) || isNaN(R) || (T.push(R), U.push(N)), m ? Ma ? (this.lineColorSwitched = sa, this.fillColorsSwitched = tb) : (this.lineColorSwitched = Da, this.fillColorsSwitched = Ka) : (this.lineColorSwitched = z.lineColor, this.fillColorsSwitched = z.fillColors), this.dashLengthSwitched = z.dashLength;
                            ...
                            if (!isNaN(Y)) {
                                ...
                                if (!(Y < Pb && na < Pb || Y > Qb && na > Qb)) {
                                    ...
                                    if (r) {
                                        ...
                                        O < q && 0 < M && (pa = new d.Cuboid(h, da, M, G - a.d3x, K - a.d3y, Ia, Ta, aa, ua, V, ga, u, r, ba, $a, kb, oa), z.columnWidth = Math.abs(da), z.columnHeight = Math.abs(M))
                                    } else {
                                        ...
                                        Q < n + ca * G && 0 < M && (this.showOnAxis && (O -= K / 2), pa = new d.Cuboid(h, M, da, G - a.d3x, K - a.d3y, Ia, Ta, aa, ua, this.lineAlpha, ga, u, r, ba, $a, kb, oa), z.columnHeight = Math.abs(da), z.columnWidth = Math.abs(M))
                                    }
                                }
                                if (pa && (za = pa.set, d.setCN(a, pa.set, "graph-" + this.type), d.setCN(a, pa.set, "graph-" + this.id), z.className && d.setCN(a, pa.set, z.className, !0), z.columnGraphics = za, za.translate(Q, O), this.columnsSet.push(za), (z.url || this.showHandOnHover) && za.setAttr("cursor", "pointer"), !P)) {
                                    ...
                                    "3d" == I && (r ? (J = (this.end + 1 - L) * C - c - 1E3 * this.depthCount, xa += G * this.columnIndex, ia += G * this.columnIndex, z.y += G * this.columnIndex) : (J = (C - c) * (L + 1) + 1E3 * this.depthCount, ya += K * this.columnIndex, ja += K * this.columnIndex, z.y += K * this.columnIndex));
                        ...
                        case "candlestick":
                            if (!isNaN(na) && !isNaN(Y)) {
                                ...
                                pa && (za = pa.set, z.columnGraphics = za, ea.push(za), za.translate(Q, O - aa / 2), (z.url || this.showHandOnHover) && za.setAttr("cursor", "pointer"), Va && (ea.push(Va), ea.push(ab)), xa = H, ya = F, r ? (ja = F, ia = H, "open" == l && (ia = R), "high" == l && (ia = Pa), "low" == l && (ia = Oa)) : (ja = F, "open" == l && (ja = N), "high" == l && (ja = Fa), "low" == l && (ja = Ea), ia = H), P || (z.x = r ? O + M / 2 : Q + M / 2, this.animateColumns(pa, L, H, R, F, N), this.addListeners(za, z)))
                            }
                            break;
                        case "ohlc":
                            if (!(isNaN(na) || isNaN(yb) || isNaN(zb) || isNaN(Y))) {
                                ...
                                if (r) {
                                    ...
                                    ob = d.line(h, [H, H], [Sb, Hb], Ba, V, aa, ba);
                                    ja = F;
                                    ia = H;
                                    "open" == l && (ia = R);
                                    "high" == l && (ia = Pa);
        ...
        drawSmoothedGraph: function(a, b, c, e) {
            if (1 < a.length) {
                ...
                0 < q && (m = a.join(";").split(";"), p = b.join(";").split(";"), n = "", 0 < c.length ? (c.push("M"), e.push("M"), c.reverse(), e.reverse(), m = a.concat(c), p = b.concat(e)) : (this.rotate ? (n += " L" + A + "," + b[b.length - 1], n += " L" + A + "," + b[0]) : (n += " L" + a[a.length - 1] + "," + A, n += " L" + a[0] + "," + A), n += " L" + a[0] + "," + b[0]), c = new d.Bezier(g, m, p, NaN, 0, 0, r, q, h, n), d.setCN(f, c, this.bcn + "fill"), c.path.pattern(this.pattern, NaN, f.path), k.push(c.path), u || void 0 !== t) && (w || (w = q), u || (u = t), a = new d.Bezier(g, a, b, NaN, 0, 0, u, w, h, n), a.path.pattern(this.pattern, NaN, f.path), d.setCN(f, a, this.bcn + "fill"), d.setCN(f, a, this.bcn + "fill-negative"), l.push(a.path));
                this.applyMask(l, k)
            }
        },
                        ...
                        if (this.forceShow = !1, J) {
                            ...
                            if (!c && (a != this.previousIndex || K != this.previousMostCloseGraph) && (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], G && this.valueBalloonsEnabled && B && e.balloon.enabled)) {
                                ...
                                for (k = 0; k < G.length; k++)
                                    if (x = G[k], y = NaN, (!this.oneBalloonOnly || x == K) && x.showBalloon && !x.hidden && x.balloonText && ("step" == x.type && "left" == x.stepDirection && (t = this.data[a + 1]), t)) {
        ...
        handleMouseOut: function() {
            if (this.enabled)
                if (this.zooming) this.setPosition();
                    ...
                    a.chart = this.chart;
                    this.leaveCursor || this.fire("changed", a);
...
(function() {
    ...
    d.AmRectangularChart = d.Class({
        ...
        construct: function(a) {
            ...
            this.zoomOutButtonImageSize = 15;
            this.zoomOutButtonImage = "lens";
            this.zoomOutText = "Reset"; //SHOW ALL
            this.zoomOutButtonColor = "#EEEEEE";
            this.zoomOutButtonAlpha = 0;
            this.zoomOutButtonRollOverAlpha = 0;
            this.zoomOutButtonPadding = 10;
            this.trendLines = [];
            this.autoMargins = !0;
...
(function() {
    ...
    d.wedge = function(a, b, c, e, h, f, g, k, l, m, n, q, p) {
        ...
        u ? (K || (h = " A" + r(b - f) + "," + r(c - g) + "," + r(b + f) + "," + r(c + g) + "," + r(x) + "," + r(y) + "," + r(B) + "," + r(D)), f = " M" + r(w) + "," + r(v) + " L" + r(x) + "," + r(y) + h + " L" + r(C) + "," + r(A)) : f = " M" + w + "," + v + " L" + x + "," + y + (" A" + f + "," + g + ",0," + G + ",1," + B + "," + D) + " L" + C + "," + A;
        ...
        getBox: function(a) {
            ...
            if (a.hasChildNodes()) {
                ...
                for (l = 0; l < a.childNodes.length; l++) {
                    ...
                    m = f.width + m;
                    isNaN(m) || (e = Math.max(e, m));
                    f = f.height + n;
                    isNaN(f) || (d = Math.max(d, f))
                }
                0 > g && (b += g);
                0 > k && (c += k)
            }
        ...
        createEntry: function(a) {
            if (!1 !== a.visibleInLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    var t;
                    isNaN(this.gradientRotation) || (t = 180 + this.gradientRotation);
                ...
                (f = this.switchType) && "none" != f && 0 < m && ("x" == f ? (r = this.createX(), r.translate(m / 2, m / 2)) : r = this.createV(), r.dItem = a, !0 !== a.hidden ? "x" == f ? r.hide() : r.show() : "x" != f && r.hide(), this.switchable || r.hide(), this.addListeners(r, a), a.legendSwitch = r, l.push(r), d.setCN(b, r, "legend-switch"));
                f = this.color;
